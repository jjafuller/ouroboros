...
// VsData contains visual studio structural data
// ProjectTypeGUID is a map of known Visual Studio project type GUIDs
...
var VsData = struct {
	...
	SourceFileExts: map[string]string{
		".asmx":   "Deployment",
		".asp":    "Active Server Page",
		".c":      "C/C++ source",
		".ccp":    "C++ source",
		".cs":     "C# source",
		".disco":  "Dynamic discovery document (handles XML web service discovery)",
		".fs":     "F# source",
		".h":      "Header (include)",
		".java":   "Java source",
		".jsl":    "J# source",
	...
	ProjectFileExts: map[string]string{
		...
		".vcxproj.filters": "Solution explorer add file filter",
